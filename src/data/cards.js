...
export const CARDS = {
  ...
  rezoning:       { name: 'Rezoning Permit',    cost: 120, target: 'edge',      desc: 'Turn one claimed edge back into open ground. Transports attached to it are demolished, with no refund.' },
