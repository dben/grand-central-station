...
export const CARDS = {
  ...
  coupon_book:    { name: 'Coupon Book',        cost: 30,  target: 'none',      desc: 'Twice as many travellers for two weeks, but fares pay half as much.', effect: { batchMult: 2, fareMult: 0.5 }, weeks: 2 },
